...
import './App.css';
import SongList4 from './SongList4';


export default class CTopArtists50M extends Component {
  ...
  render() {
    ...
    return (
      <div className="CTopArtists50M" style={baseStyle}>
        <div className="compContent">
          <div className='elBackground' style={style_background} />
          <div className='hasNestedComps elSongList4'>
            <SongList4 appActions={this.props.appActions} />
          </div>
