...
import './App.css';
import SongList3 from './SongList3';


export default class CTopUsers50M extends Component {
  ...
  render() {
    ...
    return (
      <div className="CTopUsers50M" style={baseStyle}>
        <div className="compContent">
          <div className='elBackground' style={style_background} />
          <div className='hasNestedComps elSongList3'>
            <SongList3 appActions={this.props.appActions} />
          </div>
