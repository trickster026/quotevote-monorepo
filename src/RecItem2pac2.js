...
export default class RecItem2pac2 extends Component {

  constructor(props) {
    super(props);
    
    this.state = {
      recttitle: (<div>1) Hit ‘em Up - 2pac</div>),
      recttitle_plainText: "1) Hit ‘em Up - 2pac",
    };
  }
  ...
  render() {
    ...
    return (
      <div className="RecItem2pac2" style={baseStyle}>
