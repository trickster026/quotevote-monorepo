...
export default class RecItemBIG2 extends Component {

  constructor(props) {
    super(props);
    
    this.state = {
      rectitle: (<div>2) Who Shot Ya - Notorious BIG</div>),
      rectitle_plainText: "2) Who Shot Ya - Notorious BIG",
    };
  }
  ...
  render() {
    ...
    return (
      <div className="RecItemBIG2" style={baseStyle}>
