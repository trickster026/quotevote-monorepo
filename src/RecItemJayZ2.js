...
export default class RecItemJayZ2 extends Component {

  constructor(props) {
    super(props);
    
    this.state = {
      rectitle: (<div>4) Takeover - Jay Z</div>),
      rectitle_plainText: "4) Takeover - Jay Z",
    };
  }
  ...
  render() {
    ...
    return (
      <div className="RecItemJayZ2" style={baseStyle}>
