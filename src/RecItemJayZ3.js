...
export default class RecItemJayZ3 extends Component {

  constructor(props) {
    super(props);
    
    this.state = {
      rectitle: (<div>4) Username - Points</div>),
      rectitle_plainText: "4) Username - Points",
    };
  }
  ...
  render() {
    ...
    return (
      <div className="RecItemJayZ3" style={baseStyle}>
