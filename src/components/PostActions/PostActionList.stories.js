...
// The component
import PostActions from './PostActionList'
...
const postActions = Array.from({ length: 20 }).map((i) => postAction)

export const PostActionList = () => <PostActions postActions={postActions} />

export const NoPostActions = () => <PostActions />

PostActionList.story = {
  parameters: {
    jest: ['PostActionList.test.js'],
  },
}
