...
export default function MessageContainer(props) {
  ...
  let messageData = [
    { Content: "I said this thing", Color: "green", Username: "steve" },
    { Content: "well I say this other thing", Color: "red", Username: "alice" },
    { Content: "I sadi it much louder", Color: "red", Username: "bolb" }
  ]
  return (
    <GridContainer className={classes.chatContainer}>
      <GridContainer className={classes.header}>
        <p className={classes.headerText} onClick={props.toggle}>
          {" "}
          Back
        </p>
      </GridContainer>
