...
import styles from "material-ui/assets/jss/material-dashboard-pro-react/layouts/rtlStyle.js"
...
export default function RTL(props) {
  ...
  const [image, setImage] = React.useState(
    require("material-ui/assets/img/sidebar-2.jpg")
  )
  ...
  const [logo, setLogo] = React.useState(
    require("material-ui/assets/img/logo-white.svg")
  )
  // styles
  ...
  const handleBgColorClick = bgColor => {
    switch (bgColor) {
      case "white":
        setLogo(require("material-ui/assets/img/logo.svg"))
        break
      default:
        setLogo(require("material-ui/assets/img/logo-white.svg"))
        break
    }
    setBgColor(bgColor)
  }
