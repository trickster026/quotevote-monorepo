    ...
    renderButtons = (status, userId) => {
        ...
        if ("NEW" === status) {
            return (
                <Card.Content extra>
                    <div className='ui two buttons'>
                        <Button name="approve" basic color='green'
                                onClick={(e) => handleButtons(userId, e)}>APPROVE</Button>
                        <Button name="decline" basic color='red'
                                onClick={(e) => handleButtons(userId, e)}>DECLINE</Button>
                    </div>
                </Card.Content>)
            ...
            return (
                <Card.Content extra>
                    <div className='ui two buttons'>
                        <Button name="resend" basic color='green'
                                onClick={(e) => handleButtons(userId, e)}>RESEND</Button>
                    </div>
                </Card.Content>)
        }
    }
            ...
            return this.props.userInviteRequests.map((user, index) => (
                <Card key={index}>
                    <Card.Content>
                        ...
                        <Card.Description style={{color: this.getStatusColor(user.status)}}>
                            {user.status}
                            <br/>
                        </Card.Description>
                    </Card.Content>
